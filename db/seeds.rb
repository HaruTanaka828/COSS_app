...
Blog.create!([
  {staff_id: 1, image:File.open("app/assets/images/blog1.jpg"), title: "ホームページを開設しました！", body: "創業から4年、ついに弊社のHPを開設致しました！こちらのブログでは社員から仕事の様子や日常を投稿して参りますので、弊社のことをより深く知って頂くきっかけになればと思います。お問い合わせメール、電話もお待ちしておりますのでお気軽にどうぞ！"},
